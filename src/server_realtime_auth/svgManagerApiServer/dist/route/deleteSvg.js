...
const deleteSvg = (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const body = lodash_1.default.isEmpty(ctx.request.body) ? ctx.query : ctx.request.body;
        yield managerService.deleteSvg(lodash_1.default.pick(body, ['filename']));
        ctx.body = undefined;
        ctx.status = 200;
    }
    catch (error) {
